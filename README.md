...
<p align="center">
    ...
    <!--START_LANG-->
	<a href="https://api.github.com/repos/cosmognaut/magpie/languages"><img src="https://img.shields.io/badge/Svelte-41.2%25-ff3e00" alt="Svelte percentage" /></a>
	<a href="https://api.github.com/repos/cosmognaut/magpie/languages"><img src="https://img.shields.io/badge/Python-43.4%25-3776ab" alt="Python percentage" /></a>
<!--END_LANG-->
</p>
...
.
├── backend
│   ├── app # utilities for interacting with the database
│   ├── data # contains the .parquet and .csv files
│   ├── database # contains database.db
...
4. The database is mounted as a volume, so it will persist between teardowns:
   ...
   ```
   To delete the persisted volume, use `docker compose down --volumes`.
5. If you prefer to orchestrate your containers manually (i.e. without using `docker compose`), you can follow the below steps:
   ```bash
   cd frontend
